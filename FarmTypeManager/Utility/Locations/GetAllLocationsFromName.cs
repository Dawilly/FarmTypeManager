...
{
    /// <summary>
    /// Methods used repeatedly by other sections of this mod, e.g. to locate tiles.
    /// </summary>
    private static partial class Utility
    {
        ...
        public static List<string> GetAllLocationsFromName(string name)
        {
            ...
            // Iterate over the locations in the game.
            foreach (var location in Game1.locations.OfType<GameLocation>())
            {
                // Iterate over each building (that contains an interior) in the location.
                foreach (var building in location.buildings.Where(building => building.indoors.Value != null)) //for each building with an interior location ("indoors")
                {
