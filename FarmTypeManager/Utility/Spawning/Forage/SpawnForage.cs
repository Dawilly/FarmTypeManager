...
public partial class ModEntry : Mod
{
    ...
    private static partial class Utility
    {
        ...
        public static bool SpawnForage(int index, GameLocation location, Vector2 tile)
        {
            ...
            {
                forageObj = new SObject(tile, index.ToString(), null, false, true, true); //generate the object (use the constructor that allows pickup)
            ...
            {
                forageObj = new SObject(tile, index.ToString(), 1); //generate the object (use the constructor that prevents pickup)
