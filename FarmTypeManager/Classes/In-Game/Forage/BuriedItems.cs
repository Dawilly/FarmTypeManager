...
{
    /// <summary>
    /// A modified subclass of StardewValley.Object designed to act like an artifact spot, but with easily customizable contents.
    /// </summary>
    ...
    public class BuriedItems : Object
    {
        /// <summary>
        /// The list of items contained by this burial spot.
        /// </summary>
        ...
        protected override void initNetFields()
        {
            ...
            // Include this class's custom field.
            this.NetFields.AddField(this.Items); 
        }

        /// <summary>
        /// An override that indicates this object type should be passable, despite the base method's result.
        /// </summary>
        ...
        /// <summary>
        /// An override that produces customizable items instead of the normal artifact spot object(s).
        /// </summary>
        public override bool performToolAction(Tool t, GameLocation location)
        {
            ...
            // If the buried items are being dug up...
            if (t is not Hoe)
            {
                return false;
            }

            // Drop this object's contents at the given location
            ...
            {
                // NOTE: modified to "false" to minimize hoedirt creation on inappropriate tiles
                location.makeHoeDirt(this.TileLocation, false);
            }

            location.playSound("hoeHit", null, null, SoundContext.Default);
            ...
            // Always return false when this check is completed
            return false; 
        }
