...
public partial class ModEntry : Mod
{
    ...
    public class PlacedItem : TerrainFeature
    {
        ...
        public override void initNetFields()
        {
            ...
            this.NetFields.AddField(this.item); //include this class's custom field
        }
        ...
        public override bool performUseAction(Vector2 tileLocation, GameLocation location)
        {
            ...
            if (Game1.player.addItemToInventoryBool(Item, true)) //add this item to the player's inventory; if successful,
            {
                ...
                DelayedAction.playSoundAfterDelay("coin", 300, location);
        ...
        {
            if (Item is SObject obj && obj.isForage(location)) //if this item is forage
            {
                ...
                else
                {
                    ...
                    if (random.NextDouble() < Game1.player.ForagingLevel / 30.0)
                        obj.Quality = SObject.highQuality; //gold quality
                    else if (random.NextDouble() < Game1.player.ForagingLevel / 15.0)
                        obj.Quality = SObject.medQuality; //silver quality
                    else
                        obj.Quality = SObject.lowQuality; //bronze quality, a.k.a. normal/no quality
                }
            }
        }
        ...
        {
            if (Item is SObject obj && obj.isForage(location)) //if this is a forage object
            {
