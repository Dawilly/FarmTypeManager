...
public class LargeResourceClump : LargeTerrainFeature
{
    ...
    {
        bool result = Clump.Value.performToolAction(t, damage, this.tilePosition.Value, location); //hit the clump and get the result (note: passing tileLocation would displace the destruction animation)
    ...
    {
        return getBoundingBox(this.tilePosition.Value);
    }
